			...
			<div className="row">
				...
				<div className="col-md-6">
					...
					<ul className="list-group">
						...
						<li className="list-group-item">{this.props.businessInfo.address.city}, {this.props.businessInfo.address.state}, {this.props.businessInfo.address.zipcode}</li>
					</ul>
				...
				<div className="col-md-2 col-md-offset-10">
					<div className="btn-group btn-group" role="group" aria-label="Large button group">
						<button type="button" className="btn btn-primary" onClick={this.handleEditClick.bind(this, this.props.businessInfo.id)}>Edit</button>
						<button type="button" className="btn btn-danger" onClick={this.handleRemoveClick.bind(this, this.props.businessInfo.id)}>Delete</button>
					</div>
				</div>
			</div>
		);
